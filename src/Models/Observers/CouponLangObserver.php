...
namespace WalkerChiu\Coupon\Models\Observers;

class CouponLangObserver
{
    /**
    ...
    {
        $query =
            config('wk-core.class.coupon.couponLang')::withTrashed()
        ...
        if (config('wk-core.lang_log') || config('wk-coupon.lang_log'))
